            ...
            <div class="w-100">
              <div class="row justify-align-center">
                ...
                <div class="col-12">
                  <div class="card p-4">
                    <div class="card-body">
                        <form action="{{ route('report-problem.send',$item->unique_code) }}" method="POST" class="form" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12 mb-4 text-center">
                                    <h2 class="mb-4">Laporan Kendala Alat</h2>
                                ...
                                <div class="col-12 mt-4">
                                    ...
                                    <input type="file" class="form-control" id="image-upload" onchange="preview(this)" name="image" accept="image/*">
                                </div>
